...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Enter arguments for breaker",
                                     usage='%(prog)s [-s][-m reset/typea/typec -c state/-c switch -i count[N] '
                                           'sleeptime [N]][-d][-d -l logfile_name]')
    parser.add_argument('-n', '--number', type=int, default=200, help="Enter '-d' to see value of current and voltage")
